...
export const PlaybackSpeedControl: React.FC<PlaybackSpeedControlProps> = ({ playbackRate, setPlaybackRate }) => {
  ...
  return (
    <div className="flex items-center space-x-2 md:space-x-3 w-full md:w-40 p-1 md:p-0">
      <SpeedIcon className="w-3 h-3 md:w-4 md:h-4 text-stone-500 flex-shrink-0" />
